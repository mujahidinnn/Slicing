...
const MyProject = () => {
    ...
    <div className="bg-slate-100 ">
      <div className="bg-slate-100 min-h-screen px-4 lg:px-10 pt-12">
        ...
        <h2 className="font-semibold text-4xl mb-7 leading-loose pl-4 lg:pl-0">
          Proyek Saya
        </h2>

        <>
          {/* Cards project dibuat oleh saya */}
          <h3 className="font-semibold text-2xl mb-4  pl-4 lg:pl-0">
            Dibuat oleh Saya
          </h3>
        ...
        <>
          <h3 className="font-semibold text-2xl mb-4 mt-16  pl-4 lg:pl-0">
