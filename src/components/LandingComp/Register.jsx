...
function Register(props) {
	...
	return (
		<div id='register' className='relative z-[10] sm:px-[10%] lg:px-[6%] sm:pb-5 lg:pb-8 sm:pt-4 lg:pt-[3%] lg:opacity-90 bg-white lg:border lg:border-[#CDCDCD] lg:shadow-[0_1px_4px_0_rgba(0,0,0,0.25)] min-h-full w-full rounded-[4%]'>
